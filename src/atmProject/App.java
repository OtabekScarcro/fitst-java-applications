...
public class App {
    public static void main(String[] args)throws Exception {
        ...
        User aUser = theBank.addUser("Otabek", "Otabaev", "1234");
        ...
        while(true) {
            ...
            curUser = App.mainMenuPrompt(theBank, sc);

            // stay in main menu until user quits
            App.printUserMenu(curUser, sc);
        }
    }

    /**
     * print App's login Menu
    ...
    public static void printUserMenu(User theUser, Scanner sc) {
        ...
        switch (choice) {
            ...
            case 2: {
                App.withdrawFunds(theUser, sc);
                break;
            }
            case 3: {
                App.depositFunds(theUser, sc);
                break;
            }
            case 4: {
                App.transferFunds(theUser, sc);
                break;
            }
            case 5: {
    ...
    public static void transferFunds(User theUser, Scanner sc) {
        ...
        // get an account to transfer from
        do {
            System.out.printf("Enter the number (1-%d) of the account\n"
